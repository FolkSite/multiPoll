...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('multipoll_core_path', null, $modx->getOption('core_path') . 'components/multipoll/') . 'model/';
            $modx->addPackage('multipoll', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/multipoll/model/schema/multipoll.mysql.schema.xml';
